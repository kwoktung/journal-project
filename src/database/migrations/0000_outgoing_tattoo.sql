...
CREATE INDEX `attachments_reference_type_idx` ON `attachments` (`reference_type`);--> statement-breakpoint
CREATE INDEX `attachments_reference_id_idx` ON `attachments` (`reference_id`);--> statement-breakpoint
